  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col bg-background-light dark:bg-background-dark overflow-x-hidden max-w-md mx-auto">
      ...
      <div className="px-6 pt-8 pb-4">
        <h1 className="text-slate-900 dark:text-slate-100 tracking-tight text-3xl font-bold leading-tight">Welcome Back</h1>
        <p className="text-slate-600 dark:text-slate-400 text-base font-normal mt-2">Login to continue to Recom24</p>
      </div>
      ...
      <form className="flex flex-col gap-4 px-6 py-4 mt-4 flex-grow">
        ...
        <div className="flex flex-col w-full">
          ...
          <div className="relative flex w-full items-stretch">
            ...
            />
            <button 
              className="absolute right-0 h-14 px-4 flex items-center justify-center text-slate-400 hover:text-primary transition-colors" 
              type="button"
      ...
      <div className="mt-auto px-6 pb-12 text-center z-10">
        <p className="text-slate-500 dark:text-slate-400 text-sm">
          ...
          <Link className="text-primary font-semibold hover:underline ml-1" href="/signup">Register here</Link>
        </p>
      </div>
